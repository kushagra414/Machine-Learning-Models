...
%               error_val(i) should give we the errors
...
%
% Note: If we are using wer cost function (linearRegCostFunction)
...
%
% Hint: we can loop over the examples with the following:
%
%       for i = 1:m
