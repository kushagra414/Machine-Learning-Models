...
%  first so that it will be easier for we to debug. Later, in part 4, we
...
%  Once our cost matches up with ours, we should proceed to implement the
...
%  After we have completed the assignment, change the MaxIter to a larger
...
%  we compute the training set accuracy.
